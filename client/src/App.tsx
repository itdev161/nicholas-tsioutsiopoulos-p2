          ...
          <header className="App-header">
            ...
            <Switch>
              <Route exact path="/">
                {user ? (
                  <React.Fragment>
                    <div><h1>BUTLER BOARD</h1></div>
                    <br></br>
                    <div><h3>Butler Board Forum:</h3></div>
                    
                    <div>Hello {user}! How may we be of service?</div>
                    <br></br>
                    <div><h5>Place requests for Butler here! Comments appreciated!</h5></div>
                    <PostList
                      posts={posts}
                  ...
                  <React.Fragment>Please Register or Login to use the Butler Board</React.Fragment>
                )}
              </Route>
